...
public class TrailerSelection extends AbstractSelection<TrailerSelection> {
    ...
    public TrailerSelection favoriteMovieId(Long... value) {
        addEquals(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection favoriteMovieIdNot(Long... value) {
        addNotEquals(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection favoriteMovieIdGt(long value) {
        addGreaterThan(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection favoriteMovieIdGtEq(long value) {
        addGreaterThanOrEquals(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection favoriteMovieIdLt(long value) {
        addLessThan(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection favoriteMovieIdLtEq(long value) {
        addLessThanOrEquals(FavoriteColumns.MOVIE_ID, value);
        return this;
    }

    public TrailerSelection orderByFavoriteMovieId(boolean desc) {
        orderBy(FavoriteColumns.MOVIE_ID, desc);
        return this;
    }

    public TrailerSelection orderByFavoriteMovieId() {
